...
Spratelloides_delicatulus_fresh <- read_excel("AlbatrossPhillipinesLWR/Albatross_Raw_Data/Fresh_LWR_Data/Spratelloides_delicatulus_fresh.xlsx")
View(Spratelloides_delicatulus_fresh)
summary(Spratelloides_delicatulus_fresh)
y <- c(Spratelloides_delicatulus_fresh$Mass_g)
xS <- c(Spratelloides_delicatulus_fresh$SL_cm)
xT <- c(Spratelloides_delicatulus_fresh$TL_cm)
